...
public class D_Casting {
	...
	public void casting1() {
		...
		// > 대입연산
		double d1 = /*(double)*/i1;	//원래는 double d1 = (double)il; 이지만 (double)은 생략이 가능하다!
		...
		double result2 = /*(double)*/i2 + d2;	// 12 + 3.3 => 12.0 + 3.3 => 15.3
												//작은놈이 큰놈에 마춰짐 int(4byte) --> double(8byte)
		...
		//		정수형			실수형
		// 실수형은 어떠한 정수형보다도 훨씬 더 크 범위의 값을 저장할 수 있음!!
		long l5 = 1000000000L;
	...
	public void casting2() {
		...
		double d2 = 162.3;
		int i2 = (int)d2; // 데이터 손실 발생!! 162.3 --> 162
		...
		// 해결방법 1. 연산결과값을 int형으로 강제형변환해준 뒤 담기
