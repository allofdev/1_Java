...
public class Run {
	public static void main(String[] args) {
		...
		// ArrayList 컬렉션 사용해보기
		// ArrayList<E>  --> 제네릭	뒤에꺼는<Music>대신 <>로 사용가능
		ArrayList<Music> list = new ArrayList<>(3); // 크기 : 기본적으로10이지만 따로 지정 해줄 수 있음!!
		...
		// 9. isEmpty() : 컬렉션이 비어있는지 묻는 메소드(비어있으면 true, 비어있지 않으면 false) **
		System.out.println(list.isEmpty());
		
		// 10. clear() : 컬렉션에 담긴 객체들 싹 비워주는 메소드
		//list.clear(); 다음내용 위해 주석처리
		System.out.println(list);
		System.out.println(list.isEmpty());
		...
		*/
		...
		// 향상된 for문(for each문)
		for(Music o : list) { // o = list.get(0); --> o = list.get(1); --> o = list.get(2); ...
