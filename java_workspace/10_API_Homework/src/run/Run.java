...
public class Run {
	...
	public static void main(String[] args) {
		...
		Book[] bArr = bc.printAll();
		
		for(int i=0; i<bc.printAll().length; i++) {
			if (bArr[i] != null) {
				System.out.println(bc.printAll()[i]);
			}
		}
		...
		String formatDate = bc.printBookPublishDate();
		...
		Book[] b = bc.searchBook(searchTitle);
