...
public class E_Logical {
	 ...
	 * - 두 논리값을 연산하는 연산자
	 * 
	 * 논라값 && 논리값 : 두 논리값 모두 true일 경우 연산 결과도 true
	 * 논리값 || 논리값 : 왼쪽, 오른쪽 둘중에 하나라도 true일 경우 연산 결과도 true
	 */
	...
	public void method2() {
		...
		boolean result = (ch >= 'A' && ch <= 'Z');	// 아래 코드가 보기 편하지만 이게 권장사항
	 ...
	 * false && true	=> false
	 * false && false	=> false
	 * --> && 연산자를 기준으로 앞의 결과가 false값이 나온다면 뒤의(연산)은 궂이 실행되지 않음!!
	 * 
	 * 
