...
public class G_Compound {
	...
	public void method() {
		...
		/*
		num++;
		num++;	=> 이렇게 3씩 증가하는 방법을 num += 3; 을통해 한번에 할 수 있음
		num++;
		*/
		
		num += 3;	// num =+ 3;은 num에 양수3을 대입하는 구문
		...
		str += "World";	// str = str + "World";	// 문자열 + 문자열	=> 문자열
		System.out.println("최종 str : " + str);
		
		str += 'A';		// str = str + 'A';		// 문자열 + 문자	=> 문자열
		System.out.println(str);
		
		str += 1;		// str = str +1;		// 문자열 + 숫자	=> 문자열
		System.out.println(str);
