...
public class F_Triple {
	 ...
	 * 
	 * 조건식은 반드시 true 또는 false가 낭게끔 작성해야됨!
	...
	public void method1() {
		...
		// 사용자가 입력한 정수값이 양수인지 아닌지 판별한 후 출력
	...
	public void method2() {
		...
		System.out.println(num1 + " X " + num2 + " = "  + (num1 * num2) + "은(는)" + result);
		
	}
	
	public void method3() {
		
		// 사용자가 입력한 정수값이 짝수인지 홀수인지 판별한 후 출력
		...
		//String result = (num % 2 == 0 ? "짝수이다" : "홀수이다");	// 같은 결과
		//String result = (num % 2 == 1 ? "홀수이다" : "짝수이다");	// 같은 결과
		String result = (num % 2 !=1 ? "짝수이다" : "홀수이다");		// 같은 결과
	...
	public void method4() {
		...
		// 사용자가 입력한 영문자 값이 대문자인지 아닌지 판별한 후 출력
		Scanner sc = new Scanner(System.in);
	...
	public void method5() {
		...
		//String result = (num > 0 ? "양수이다" : (num == 0 ? "0이다" : "음수이다"));	//같은 결과
		String result = (num > 0 ? ("양수이다") : (num < 0 ? "음수이다" : "0이다"));	//같은 결과
